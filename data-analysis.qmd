...
arrests <- 
    ...
    mutate(
        ...
        departure_country_match = 
            if_else(departure_country == citizenship_country, 1, 0)
        ) |> 
...
2. Circular barchart, each group is continent citizen origin, the bars
...
arrests |> 
    select(citizenship_country, departure_country) |> 
    mutate(
