...
The data comes from the Deportation Data Project [@deportationdataproject2025]. I used the ICE Arrests Processed dataset. The data dictionary can be found [@deportationdata_ice_codebook].

```{r, echo=FALSE}
knitr::include_graphics("files-docs/protest-pic.jpg")
```
Photo from coloralamexicana on Instagram [@instagram_author_2025].
